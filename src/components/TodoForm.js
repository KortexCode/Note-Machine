...
function TodoForm(props) {
  ...
  return (
    <form className="form">
      <label className="form__title" name="addtodo">
        {props.text}
      </label>
      <textarea
      ...
      <div className="form__btn-container">
        <button type="button" onClick={onSend} className="form__btn-action">
          {props.action}
        </button>
        <button type="button" onClick={onCancel} className="form__btn-cancel">
          Cancelar
        </button>
      </div>
    </form>
